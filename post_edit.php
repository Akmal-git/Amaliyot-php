<div class="container pt-5 mt-5">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['PUT'])) {
        ...
        $statement = $pdo->prepare("UPDATE posts SET sarlavhaa=:sarlavhaa, matinn=:matinn WHERE id=:id ");
        $statement->execute([
            'sarlavhaa' => $sarlavha,
            'matinn' => $matin,
            'id' => $id,
    ...
    <form method="POST" action="" class="p-5 mb-4 bg-body-tertiary rounded-3">
        ...
        <div class="mb-3">
            ...
            <input name="sarlavha" type="text" class="form-control" value="<?= $post['sarlavhaa'] ?>">
        </div>
        <div class="mb-3">
            <label class="form-label">Matin</label>
            <textarea name="text" class="form-control" rows="3"><?= $post["matinn"] ?></textarea>
        </div>
